...
require_once('lib/TwitterOAuth/src/Config.php');
require_once('lib/TwitterOAuth/src/Response.php');
require_once('lib/TwitterOAuth/src/HmacSha1.php');
require_once('lib/TwitterOAuth/src/SignatureMethod.php');
require_once('lib/TwitterOAuth/src/Consumer.php');
require_once('lib/TwitterOAuth/src/Token.php');
require_once('lib/TwitterOAuth/src/Request.php');
require_once('lib/TwitterOAuth/src/Util.php');
require_once('lib/TwitterOAuth/src/TwitterOAuthException.php');
...
class TwitterOAuth extends Config
{
    ...
    private function request($url, $method, $authorization, array $postfields)
    {
        ...
        if (curl_errno($curlHandle)>0) {
            ...
            echo "Connection Error,Please Check Your Network Connection";
        }
